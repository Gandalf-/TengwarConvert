...
public class TengwarConvert {
  ...
  // fileInput
  //Reads in the given file, and converts each line of the input in turn.
  ...
  public static void fileInput (String[] args) {
    try {
      ...
      PrintWriter writer = new PrintWriter(
          inputFileName.substring(0, args[0].length() -4) + "_converted.txt");
      ...
      while (in.hasNext() ) {
        ...
        if (input.length() != 0) {
          //Move each word, defined by being seperated by a space, into an 
          // array of Strings called wordsArray[]
